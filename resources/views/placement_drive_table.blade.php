...
<html lang="en">
   ...
   <head>
      ...
      <title>PVGCOE - Placement Drive</title>
                            ...
                            <table class="table  table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php $i++ ?>
                                            ...
                                            <td><center><a href="{{$d_data->apply_link}}" target="_blank" style="float: right"><i class="fas fa-external-link-alt"></i> Apply</a></center></td>
