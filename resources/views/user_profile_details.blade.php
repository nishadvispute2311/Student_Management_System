...
<html lang="en">
   ...
   <head>
      ...
      <title>PVGCOE - User Details</title>
      ...
      <div class="main-wrapper">
         <div class="header">
            ...
            <ul class="nav user-menu">
               ...
               <li class="nav-item">
                  <h4 style="margin-top: 15px">Hey! Welcome {{$data->name}} </h4>
               </li>
               <li class="nav-item">
                  <h3 style="margin-top: 10px; font-size: 30px; margin-left: 10px; margin-right: 10px">|</h3>
               </li>
               <li class="nav-item">
                  <a href="logout"><h5 style="margin-top: -40px; color: blue;">Logout</h5></a>
               </li>
            ...
            <div class="content container-fluid">
               <div class="page-header">
                  <div class="row align-items-center">
                     <div class="col">
                        <center><h3 class="page-title" style="margin-top: 0px">Add Details</h3></center>
                        {{-- <ul class="breadcrumb">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <select class="form-control" name="designation">
                                          ...
                                          <option>Student at PVGCOE</option>
                                          <option>Staff member at PVGCOE</option>
                                          <option>Exam Co-ordinator at PVGCOE</option>
                                          <option>TPO at PVGCOE</option>
                                       </select>
                                       <span class="text-danger">
                                          @error('designation')
                                              {{$message}}
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <textarea class="form-control" name="address" id="address" style="height: 42px"></textarea>
                                       <span class="text-danger">
                                          @error('address')
                                              {{$message}}
                                          @enderror
                                 ...
                                 <div class="col-12">
                                    ...
                                    <center><button type="submit" class="btn btn-primary" id="sub_btn">Submit</button></center>
                                 </div>
                              </div>
                           </form>
                        </div>
      ...
      {{-- <script>
         $(document).ready(function(){
            $("#sub_btn").click(function(){
                  // var desig = $("#designation option:selected").val();
