...
<html lang="en">
   ...
   <head>
      ...
      <title>PVGCOE - Student Exam Result</title>
            ...
            <div class="sidebar-inner slimscroll">
               <div id="sidebar-menu" class="sidebar-menu">
                  <ul>
                     ...
                     <li>
                        <a href="time-table.html"><i class="fas fa-table"></i> <span>Results</span></a>
                     </li>
                     <li>
            ...
            <div class="content container-fluid">
               <div class="page-header">
                  <div class="row align-items-center">
                     <div class="col">
                        <h3 class="page-title">Exam Result Section</h3>
                        <ul >
                            {{-- <li class="breadcrumb-item"><a href="javascript:void(0)">Staff</a></li> --}}
                            {{-- <li class="">Department : {{$exam_details->branch}}</li>
                            <li class="">Exam Name : {{$exam_details->test_name}}</li>
                            <li class="">Class : {{$exam_details->class}}</li>
                            <li class="">Marks : {{$exam_details->marks}}</li> --}}


                        </ul>
                     </div>
                     <div class="col-auto text-right float-right ml-auto">
                        <a href="download_result" target="_blank" class="btn btn-outline-primary mr-2"><i class="fas fa-download"></i> Download Result</a>
