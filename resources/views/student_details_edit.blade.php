...
<html lang="en">
   ...
   <head>
      ...
      <title>PVGCOE - Student Edit Details</title>
            ...
            <div class="content container-fluid">
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="card">
                        <div class="card-body">
                           <form action="edit_details_of_student" method="post" enctype="multipart/form-data">
                              @csrf
                              <div class="row">
                                 <div class="col-12">
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <div>
                                          <input type="date" class="form-control" name="date_of_birth" value="{{$student_data->dob}}">
                                          <span class="text-danger">
                                             @error('date_of_birth')
                                                 {{$message}}
                                             @enderror
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <div>
                                          <input type="date" class="form-control" name="date_of_admission" value="{{$student_data->date_of_admission}}">
                                          <span class="text-danger">
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="student_about" value="{{$student_data->student_about}}">
                                    </div>                                    
                                 </div>
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       <label>Mobile Number</label>
                                       <input type="text" class="form-control" name="number" value="{{$student_data->student_number}}">
                                       <span class="text-danger">
                                          @error('number')
                                              {{$message}}
                                          @enderror
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="linkedin_link" value="{{$student_data->linkedin_link}}">
                                       <span class="text-danger">
                                          @error('linkedin_link')
                                              {{$message}}
                                          @enderror
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="github_link" value="{{$student_data->github_link}}">
                                       <span class="text-danger">
                                          @error('github_link')
                                              {{$message}}
                                          @enderror
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       <label>Summary</label>
                                       <textarea class="form-control" style="height: 60px;" name="summary" >{{$student_data->summary}}</textarea>
                                       <span class="text-danger">
                                          @error('summary')
                                              {{$message}}
                                          @enderror
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <textarea class="form-control" name="present_address">{{$student_data->present_address}}</textarea>
                                       <span class="text-danger">
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <textarea class="form-control" name="permanent_address">{{$student_data->permanent_address}}</textarea>
                                       <span class="text-danger">
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="father_number" value="{{$student_data->father_number}}">
                                       <span class="text-danger">
                                          @error('father_number')
                                              {{$message}}
                                          @enderror
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <input type="email" class="form-control" name="father_email" value="{{$student_data->father_email}}">
                                       <span class="text-danger">
                                          @error('father_email')
                                              {{$message}}
                                          @enderror
