               ...
               <div class="loginbox">
                  ...
                  <div class="login-right">
                     <div class="login-right-wrap">
                        <h1>Alert</h1><br>
                        <p class="account-subtitle">Sorry! This is an invalid link</p>
                        ...
                        <div class="text-center dont-have">Back to Login Page? <a href="/iotsms/public/login">Login</a></div>
                     </div>
                  </div>
               </div>
            </div>
