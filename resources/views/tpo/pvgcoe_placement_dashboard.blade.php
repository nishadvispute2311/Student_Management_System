...
<head>
    ...
    <title>PVGCOE - Placement Dashboard</title>
    ...
    <style>
        ...
        .placed_img{
            ...
            /* height: 200px;
            width: 200px; */
            filter: drop-shadow(10px 10px 8px purple);
        }
     </style>
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <center><i><h3><b>Welcome!! Prof. {{$user_data1->fname}} {{$user_data1->lname}} to the PVGCOE Nashik Placement Dashboard</b></h3></i></center>
                            </div>
                        </div>

                        <div class="card">
                            <div class="card-header">
                                <h3><center>Placement Record 2022-23</center></h3>
                            </div>
                            <div class="card-body">
                                <div class="row follow-sec">
                                    @foreach ($placed_data as $p_data)
                                        <div class="col-md-4 mb-3">
                                            <center><img class="placed_img" src="{{asset('placed_students_images')}}/{{$p_data->student_image}}" alt="" width="200px" height="200px" style="margin-bottom:20px;"></center>
                                            <center><p><b>{{$p_data->student_name}}</b></p></center>
                                            <center><p>{{$p_data->branch}}</p></center>
                                            <center><p>[{{$p_data->company_name}}, {{$p_data->salary}}]</p></center>
