...
<head>
    ...
    <title>PVGCOE - Placed Student Record</title>
        ...
        <div class="header">
            <div class="header-left">
                <a href="index.html" class="logo">
                    <img src="assets/img/pvg_logo.jpg" alt="Logo" style="border-radius: 100%"> <span>PVGCOE
                        Nashik</span>
                </a>
                                ...
                                <table class="table  table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">
                                                <center>Date of Selection</center>
                                            </th>
                                            <th scope="col">
                                                <center>Selection Proof</center>
                                            </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center><img
                                                        src="{{asset('placed_students_images')}}/{{$d_data->student_image}}"
                                                        width="50px" height="50px" style="border-radius: 50%" alt="">
                                                </center>
                                            </td>
                                            <td>
                                                <center>{{$d_data->student_name}}</center>
                                            </td>
                                            <td>
                                                <center>{{$d_data->student_id}}</center>
                                            </td>
                                            <td>
                                                <center>{{$d_data->branch}}</center>
                                            </td>
                                            <td>
                                                <center>{{$d_data->company_name}}</center>
                                            </td>
                                            <td>
                                                <center>{{$d_data->job_role}}</center>
                                            </td>
                                            <td>
                                                <center>{{$d_data->salary}}</center>
                                            </td>
                                            <td>
                                                <center>{{$d_data->batch}}</center>
                                            </td>
                                            <td>
                                                <center>{{$d_data->date_of_selection}}</center>
                                            </td>
                                            <td>
                                                <center><a href="{{$d_data->proof}}" target="_blank"><i
                                                            class="fas fa-external-link-alt"></i> View</a></center>
                                            </td>
