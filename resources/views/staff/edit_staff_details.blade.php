...
<html lang="en">
   ...
   <head>
      ...
      <title>PVGCOE - Staff Edit Details</title>
            ...
            <div class="content container-fluid">
               <div class="page-header">
                  <div class="row align-items-center">
                     <div class="col">
                        ...
                        <ul class="breadcrumb">
                           <li class="breadcrumb-item"><a href="students.html">Staff</a></li>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="card">
                        <div class="card-body">
                           <form action="edit_details_of_staff" method="post" enctype="multipart/form-data">
                              @csrf
                              <div class="row">
                                 <div class="col-12">
                                    <h5 class="form-title"><span>Saff Information</span></h5>
                                 </div>
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="staff_id" value="{{$user_data1->user_id}}" readonly>
                                    </div>
                                 </div>
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <div>
                                          <input type="date" class="form-control" name="date_of_birth" value="{{$staff_data->dob}}">
                                          <span class="text-danger">
                                             @error('date_of_birth')
                                                 {{$message}}
                                             @enderror
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <div>
                                          <input type="text" class="form-control" name="qualification" value="{{$staff_data->qualification}}">
                                          <span class="text-danger">
                                             @error('qualification')
                                                 {{$message}}
                                             @enderror
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="number" value="{{$staff_data->mobile}}">
                                       <span class="text-danger">
                                          @error('number')
                                              {{$message}}
                                          @enderror
                                 ...
                                 <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="linkedin_link" value="{{$staff_data->linkedin_link}}">
                                       <span class="text-danger">
                                          @error('linkedin_link')
                                              {{$message}}
                                          @enderror
