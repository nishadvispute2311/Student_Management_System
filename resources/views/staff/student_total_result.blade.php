...
<html lang="en">
   ...
   <head>
      ...
      <title>PVGCOE - Student Result Record</title>
                  ...
                  <div class="row align-items-center">
                     <div class="col">
                        ...
                        <ul class="breadcrumb">
                           ...
                           <li class="breadcrumb-item"><a href="#">{{$staff_data->class_incharge}} , {{$staff_data->department}}</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
                            ...
                            <table class="table  table-striped">
                                <thead>
                                  <tr>
                                    ...
                                    <th scope="col"><center>Percentage</center></th>
                                    <th scope="col"><center>Result</center></th>
                                  </tr>
                                </thead>
                                <tbody>
                                  
                                  @foreach ($student_result_data as $sr_data)
                                    
                                          <tr>
                                             <th scope="row"><center>{{$sr_data->student_id}}</center></th>
                                             <td><center>{{$sr_data->student_name}}</center></td>
                                             <td><center>{{$sr_data->exam_name}}</center></td>
                                             <td><center>{{$sr_data->marks_obtained}}</center></td>
                                             <td><center>{{$sr_data->total_marks}}</center></td>
                                             <td><center>{{$sr_data->percentage}}</center></td>
                                             <td><center>{{$sr_data->status}}</center></td>
