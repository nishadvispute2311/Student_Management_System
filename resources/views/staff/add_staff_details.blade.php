...
<html lang="en">
   ...
   <head>
      ...
      <title>PVGCOE - Staff Add Details</title>
                  ...
                  <ul>
                     ...
                     <li class="submenu active">
                        ...
                        <ul>
                           ...
                           <li><a href="add_student" class="active">Staff Add</a></li>
                        </ul>
                     </li>
                     {{-- <li class="submenu">
                     ...
                     <li>
                        <a href="exam.html"><i class="fas fa-clipboard-list"></i> <span>Exam Result</span></a>
                     </li>
                     <li>
            ...
            <div class="content container-fluid">
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="card">
                        <div class="card-body">
                           <form action="add_details_of_staff" method="post" enctype="multipart/form-data">
                              @csrf
                              <div class="row">
                                 <div class="col-12">
