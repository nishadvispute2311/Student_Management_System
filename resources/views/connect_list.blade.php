...
<html lang="en">
   ...
   <head>
      ...
      <title>PVGCOE - Student Connection List</title>
            ...
            <div class="content container-fluid">
               <div class="page-header">
                  <div class="row align-items-center">
                     <div class="col">
                        <h3 class="page-title">My Connections</h3>
                        <ul class="breadcrumb">
                     ...
                     <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table  table-striped">
                                ...
                                <tbody>
                                    <?php $i = 0 ?>
                                    @foreach ($followers_data as $f_data)
                                    <?php $i++ ?>
                                            <tr>
                                            <th scope="row"><center>{{$i}}</center></th>
                                            <td><center><img src="{{asset('all_students_profile_images')}}/{{$f_data->friend_image}}" width="50px" height="50px" style="border-radius: 50%" alt=""></center></td>
                                            <td><center>{{$f_data->friend_name}}</center></td>
                                            <td><center>{{$f_data->friend_email}}</center></td>
                                            </tr>
                                    @endforeach
                                  
                                          {{-- <tr>
                                            <th scope="row"><center>2</center></th>
                                            <td><center><img src="{{asset('all_students_profile_images')}}/NS1674559134G_1674627765.jpg" width="50px" height="50px" style="border-radius: 50%" alt=""></center></td>
                                            <td><center>Nirupam Gangurde</center></td>
                                            <td><center>nirupamgangurde242@gmail.com</center></td>
